...
app.get('/landmarktechnologies', function(request, response) {
    ...
    response.write("<h2><center>Welcome to  Landmark Technologies. Please kindly Contact +14372152483 for more information or send an email to info@mylandmarktech.com <center></h2>" );
    response.end();
